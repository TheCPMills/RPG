...
public class Ranged extends main.Weapon
{   public Ranged(String name, int damage, String rarity, int die) throws IllegalEnumException
    {   super(name, damage, Convert.toRarity(rarity), DamageType.Piercing, die);
    }
